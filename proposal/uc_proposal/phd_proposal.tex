...
Therefore, I will use computer simulated communities to estimate the population dynamics of the species in the community, and then I will directly quantify stability properties from fluctuations in the species populations \citep{Bastolla2009}.
...
To answer these questions, I will use a combination of previously collected empirical data, complex-network theory---built upon tools from statistical physics and the social sciences\citep{Strogatz2001, Newman2003}, and computer simulations of the species populations in the community\citep{Bastolla2009, Garcia-Algarra2013}.
In particular, I will contrast the structural (complex networks) and dynamical (population models) properties of real and simulated ecosystems under different invasion/defaunation conditions \citep{Romanuk2009, Rohr2014, Tylianakis2014}, and evaluate their effects on ecosystem resilience.





In combination with low levels of pollinator diversity, that makes New Zealand flora particularly vulnerable to declines in pollination services \citep{Newstrom2005, Cox2000}.
...
pollination systems worldwide are currently being disrupted simultaneously by both the loss of previously important species, and the introduction of invasive species \citep{Cox2000}
...
For example, the introduction, and subsequent invasion, of stoats in New Zealand was an expensive mistake in which species interactions were not taken into account \citep{Kuiti1992, Thomson2011}.
Moreover, although we have identified the effects of this invasion on some iconic native species, we currently do not understand how the changes on ecosystem dynamics is affecting the resilience of the ecosystems as a whole.
