...
```{r fig-species-level, fig.cap="Probability density of the control capacity $\\phi$ of (a) plants and (b) pollinators across all networks. The control capacity of all invasive species is $\\phi = 1$ and is depicted with solid circles."}
