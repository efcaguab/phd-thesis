...
\documentclass[
		twoside,openright,titlepage,numbers=noenddot,headinclude,%1headlines,
                ...
                parskip=half,DIV=calc,
                BCOR=8mm,paper=b5,fontsize=11pt, % Binding correction, paper type and font size
...
% \usepackage[a4,frame,axes,cam,center]{crop}
%----------------------------------------------------------------------------------------
%	DOCUMENT VARIABLES
...
\PassOptionsToPackage{eulerchapternumbers, listings,drafting, pdfspacing, subfig,beramono,eulermath,parts,floatperchapter,style=style/classicthesis-arsclassica}{style/classicthesis}
...
\cleardoublepage
%\includegraphics[width=1.3\linewidth]{images/pollination-01-A4.pdf}
\thispagestyle{empty}
\tikz[remember picture,overlay] \node[opacity=1,inner sep=0pt] at (current page.center){\includegraphics[width=1.025\paperwidth,height=1.025\paperheight]{images/pollination-01-A4.pdf}};
\begin{center}
\vspace*{\fill}
Photo: Bartosz Cuber
\end{center}
