...
I look at the possible implications that the number of shared partners may have on network structure. 
However, neither the number nor the identity of the partners a species has is constant across the different ecological communities the species may inhabit [@gravel_bringing_2018]. 
...
In \autoref{sdm-networks}, I investigate how the environment may influence the number of partners each species has in an ecological community. 
