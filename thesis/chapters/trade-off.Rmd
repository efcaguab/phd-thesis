...
```{r fig-var-impotance-trade-offs, fig.height = 1.2, out.extra='', fig.scap = "Importance of ecological factors", fig.cap = "Relative importance of ecological factors on pollen deposition. The plant's visit potential and relative floral abundance are the most important factors determining the deposition of conspecific and heterospecific pollen. Meanwhile, the number of shared pollinators was generally less important. The graph shows the relative importance calculated as the sum of the Akaike weights of the candidate models that included the selected factor."}
