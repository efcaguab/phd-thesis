...
When plants share pollinators, pollination can be dramatically different to what it would be without sharing. 
...
By examining comprehensive empirical data in eleven natural communities, we show here that pollination is—surprisingly—only partially influenced by the number of shared pollinators. 
Instead, the factors that most influence pollination (abundance and visit effectiveness) also introduce a trade-off between the absolute amount of conspecific pollen received and the amount relative to heterospecific pollen. 
