...
```{r fig-species-partial, fig.height = fig_sizes()$two_column_width/2*4*0.85, fig.cap= "Partial-residual plots for the independent variables: (a) contribution to nestedness, (b) visitation strength, (c) asymmetry of dependences, and (d) degree. Partial-residual plots show the relationship between control capacity and each of the independent variables while acccounting for all other remaining variables. Ploted values correpond to the predictions of the models weighted average.", fig.scap="Partial-residual plots of independent variables", out.extra='', cache = TRUE}
