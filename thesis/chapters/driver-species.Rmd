...
Among the various possibilities *structural controllability*, a branch of network control theory, appears to be a strong candidate [@isbell_human_2013]. 
...
We then expand existing methods from control theory to effectively link the controllability (see Glossary) of a network with the role of its constituent species.
...
```{r tab-model-selection-table, cache = FALSE, fig.showtext = TRUE}
