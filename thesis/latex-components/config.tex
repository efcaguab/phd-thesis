...
% Weird characters used in the thesis
...
\newcommand{\myTitle}{Plant--pollinator communities\xspace}
\newcommand{\mySubtitle}{environmental gradients, trade-offs, and controllability}
...
\newcommand{\myVersion}{Version 1.1.1}
